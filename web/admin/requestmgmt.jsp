                                                            ...
                                                            <table id="mgmtTable"
                                                                ...
                                                                <tbody>
                                                                    <% if (requests !=null) { for (RequestBean req :
                                                                        ...
                                                                        !=null; String badgeClass; String
                                                                        status=req.getStatus(); if
                                                                        ("Completed".equals(status)
                                                                        || "Payment Completed" .equals(status)) {
                                                                        badgeClass="badge-success" ; } else if
                                                                        ("Cancelled".equals(status) || "Rejected"
                                                                        .equals(status)) { badgeClass="badge-danger" ; }
                                                                        else if ("Pending Payment".equals(status)
                                                                        || "Pending Pickup" .equals(status)) {
                                                                                                    ...
                                                                                                    <%-- Admin Actions
                                                                                                        ...
                                                                                                        <% if
                                                                                                            ...
                                                                                                            <% if
                                                                                                                ...
                                                                                                                { %>
                                                                                                                <a href="${pageContext.request.contextPath}/admin/payment_confirm.jsp?requestID=<%= req.getRequestID() %>"
