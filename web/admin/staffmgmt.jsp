            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <button class="btn btn-success ml-auto" data-toggle="modal" data-target="#addModal"><i class="fas fa-user-plus"></i> Add Staff</button>
                    </div>
                    <div class="card-body">
                        <table id="userTable" class="table table-bordered table-hover">
                            <thead>
                                <tr><th>Staff ID</th><th>Name</th><th>Email</th><th>Phone</th><th>Actions</th></tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-primary btn-sm edit-btn" 
                                                    ...
                                                    data-email="${s.staffEmail}" data-phone="${s.staffPhoneNo}">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <a href="${pageContext.request.contextPath}/StaffMgmtServlet?action=delete&id=${s.staffID}" class="btn btn-danger btn-sm delete-confirm"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
...
<div class="modal fade" id="addModal">
    <div class="modal-dialog">
        <form action="${pageContext.request.contextPath}/StaffMgmtServlet?action=add" method="POST" class="modal-content">
            <div class="modal-header"><h5 class="modal-title">Add Staff</h5></div>
...
<div class="modal fade" id="editModal">
    <div class="modal-dialog">
        <form action="${pageContext.request.contextPath}/StaffMgmtServlet?action=update" method="POST" class="modal-content">
            <div class="modal-header"><h5 class="modal-title">Edit Staff</h5></div>
            <div class="modal-body">
