<%@ page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ page import="Greencycle.model.CustomerBean" %>
        <% CustomerBean customer=(CustomerBean) session.getAttribute("user"); String role=(String)
            session.getAttribute("role"); if (customer==null || !"customer".equals(role)) {
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-6">
                                        <div class="small-box bg-info">
                                            ...
                                            <a href="${pageContext.request.contextPath}/customer/pickuprequest.jsp"
