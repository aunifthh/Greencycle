    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ page import="Greencycle.model.CustomerBean, Greencycle.model.AddressBean, java.util.List" %>
            ...
            <% // Retrieve session data 
                ...
                String role=(String) session.getAttribute("role"); // Redirect if not logged in as customer 
                if (customer==null || !"customer".equals(role)) { response.sendRedirect(request.getContextPath() + "/index.jsp?error=1" );
                return; } // Set current page for sidebar highlighting request.setAttribute("currentPage", "profile" );
                %>
                ...
                <body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <script
                        src="<%= request.getContextPath()%>/app/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
                            ...
                            document.addEventListener('click', function (e) {
                                if (e.target && e.target.classList.contains('edit-btn')) {
                                    ...
                                    const data = {
                                        ...
                                        line2: btn.getAttribute('data-line2'),
                                        poscode: btn.getAttribute('data-poscode'),
                                        city: btn.getAttribute('data-city'),
                                        state: btn.getAttribute('data-state'),
                                        remarks: btn.getAttribute('data-remarks'),
                                        isDefault: btn.getAttribute('data-default') === 'true'
                                    };
