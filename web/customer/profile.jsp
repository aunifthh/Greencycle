...
<%
    String customerJson = (String) request.getAttribute("customerJson");
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="tel" id="phoneInput" class="form-control" placeholder="Phone Number" required>
                                ...
                                <div class="card card-primary mt-4">
                                    ...
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            <input type="text" id="bankNameInput" class="form-control" placeholder="Bank Name">
                                            <div class="input-group-text"><i class="fas fa-university"></i></div>
                                        </div>
                                        <div class="input-group mb-3">
                                            <input type="text" id="bankAccountInput" class="form-control" placeholder="Account Number">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="remarks" class="form-control" rows="2" placeholder="E.g., Near blue gate, ring bell twice"></textarea>
                            </div>
